...
gdjs.homeSceneCode.userFunc0x1af7868 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.homeSceneCode.userFunc0x1af78d0 = function GDJSInlineCode(runtimeScene) {
"use strict";
var UID = localStorage.getItem("UID")
...
document.head.appendChild(dep);
  ...
  elemDiv.style.cssText = 'position:absolute;bottom:250px;left:calc('+screenCenter+'px - 300px / 2 );z-index:99999;';
  ...
  elemDiv.style.cssText = 'width: 300px; height: 40px; background-color: #4052D6; border: none;color: white;text-align: center;text-decoration: none;display: inline-block;font-size: 17px;margin: 4px 2px;cursor: pointer;position:absolute;bottom:300px;left:calc('+screenCenter+'px - 300px / 2 ); z-index:99999;border-radius: 2px;';
  //document.body.appendChild(elemDiv);
  document.body.insertBefore(elemDiv, document.body.firstChild);
...
gdjs.homeSceneCode.userFunc0x1af7868(runtimeScene);
...
gdjs.homeSceneCode.userFunc0x1af78d0(runtimeScene);
...
gdjs.homeSceneCode.userFunc0x8fddc8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.homeSceneCode.userFunc0x8fddc8(runtimeScene);
