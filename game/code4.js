...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(43).getAsNumber() > 3628 - (1280 / 2));
}
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().getFromIndex(43).setNumber(3628 - (1280 / 2));
}}
...
gdjs.cardSceneCode.eventsList4(runtimeScene);
gdjs.cardSceneCode.GDNewSprite3Objects1.length = 0;
gdjs.cardSceneCode.GDNewSprite3Objects2.length = 0;
gdjs.cardSceneCode.GDNewSprite3Objects3.length = 0;
gdjs.cardSceneCode.GDNewTiledSpriteObjects1.length = 0;
